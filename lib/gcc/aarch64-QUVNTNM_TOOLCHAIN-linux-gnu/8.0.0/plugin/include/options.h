...
enum opt_code
{
  ...
  OPT_fcall_saved_ = 515,                    /* -fcall-saved- */
  OPT_fcall_used_ = 516,                     /* -fcall-used- */
  OPT_fcaller_saves = 517,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 518,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 519,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 520,                /* -fcheck-data-deps */
  OPT_fcheck_new = 521,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 522,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 523,                         /* -fcheck= */
  OPT_fchecking = 524,                       /* -fchecking */
  OPT_fchecking_ = 525,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 526,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 527,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 528,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 529,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 530,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 531,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 532,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 533,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 534, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 535,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 536,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 537,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 538, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 539,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 540,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 541,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 542,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 543,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 544,                       /* -fcilkplus */
  OPT_fcoarray_ = 545,                       /* -fcoarray= */
  OPT_fcode_hoisting = 546,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 547,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 548,                         /* -fcommon */
  OPT_fcompare_debug = 549,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 550,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 551,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 552,                   /* -fcompare-elim */
  OPT_fconcepts = 553,                       /* -fconcepts */
  OPT_fcond_mismatch = 554,                  /* -fcond-mismatch */
  OPT_fconserve_space = 555,                 /* -fconserve-space */
  OPT_fconserve_stack = 556,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 557,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 558,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 559,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 560,                       /* -fconvert= */
  ...
  OPT_fdec = 577,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 578,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 579,                       /* -fdec-math */
  OPT_fdec_static = 580,                     /* -fdec-static */
  OPT_fdec_structure = 581,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 582,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 583,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 584,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 585, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 586,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 587,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 588,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 589,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 590,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 591,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 592,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 593,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 594,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 595, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 596,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_generate_patch = 597,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 598,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 599,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 600,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 601,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 602, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 603,                /* -fdirectives-only */
  OPT_fdisable_ = 604,                       /* -fdisable- */
  ...
  OPT_fdump_internal_locations = 617,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 618,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 619, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 620,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 621,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 622,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 623,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 624,                 /* -fearly-inlining */
  OPT_felide_constructors = 625,             /* -felide-constructors */
  OPT_felide_type = 626,                     /* -felide-type */
  OPT_feliminate_dwarf2_dups = 627,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 628, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 629,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 630,        /* -femit-class-debug-always */
  ...
  OPT_fenforce_eh_specs = 635,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 636, */           /* -fenum-int-equiv */
  OPT_fexceptions = 637,                     /* -fexceptions */
  OPT_fexcess_precision_ = 638,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 639,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 640,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 641,           /* -fext-numeric-literals */
  ...
  OPT_fforward_propagate = 657,              /* -fforward-propagate */
  OPT_ffp_contract_ = 658,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 659,         /* -ffp-int-builtin-inexact */
  ...
  OPT_fgimple = 675,                         /* -fgimple */
  OPT_fgnat_encodings_ = 676,                /* -fgnat-encodings= */
  ...
  OPT_fgo_c_header_ = 682,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 683,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 684,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 685,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 686,                /* -fgo-debug-escape */
  ...
  /* OPT_fhelp = 697, */                     /* -fhelp */
  /* OPT_fhelp_ = 698, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 699,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 700, */                /* -fhonor-std */
  OPT_fhosted = 701,                         /* -fhosted */
  /* OPT_fhuge_objects = 702, */             /* -fhuge-objects */
  OPT_fident = 703,                          /* -fident */
  OPT_fif_conversion = 704,                  /* -fif-conversion */
  OPT_fif_conversion2 = 705,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 706,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 707,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 708,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 709,             /* -fimplicit-templates */
  ...
  OPT_finit_derived = 713,                   /* -finit-derived */
  ...
  OPT_finline_matmul_limit_ = 724,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 725,         /* -finline-small-functions */
  OPT_finput_charset_ = 726,                 /* -finput-charset= */
  OPT_finstrument_functions = 727,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 728,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 729,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 730,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 731,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 732,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 733,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 734,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 735, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 736,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 737,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 738,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 739,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 740, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 741,                    /* -fipa-profile */
  OPT_fipa_pta = 742,                        /* -fipa-pta */
  OPT_fipa_pure_const = 743,                 /* -fipa-pure-const */
  OPT_fipa_ra = 744,                         /* -fipa-ra */
  OPT_fipa_reference = 745,                  /* -fipa-reference */
  OPT_fipa_sra = 746,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 747, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 748,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 749,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 750,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 751,              /* -fira-loop-pressure */
  OPT_fira_region_ = 752,                    /* -fira-region= */
  OPT_fira_share_save_slots = 753,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 754,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 755,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 756,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 757,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 758,               /* -fivar-visibility= */
  OPT_fivopts = 759,                         /* -fivopts */
  OPT_fjump_tables = 760,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 761,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 762,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 763,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 764,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 765,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 766, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 767,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 768,             /* -fleading-underscore */
  OPT_flifetime_dse = 769,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 770,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 771,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 772,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 773,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 774,                    /* -flocal-ivars */
  /* OPT_floop_block = 775, */               /* -floop-block */
  /* OPT_floop_flatten = 776, */             /* -floop-flatten */
  /* OPT_floop_interchange = 777, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 778,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 779, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 780,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 781, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 782, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 783,                      /* -flra-remat */
  OPT_flto = 784,                            /* -flto */
  OPT_flto_compression_level_ = 785,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 786,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 787,                 /* -flto-partition= */
  OPT_flto_report = 788,                     /* -flto-report */
  OPT_flto_report_wpa = 789,                 /* -flto-report-wpa */
  OPT_flto_ = 790,                           /* -flto= */
  OPT_fltrans = 791,                         /* -fltrans */
  OPT_fltrans_output_list_ = 792,            /* -fltrans-output-list= */
  OPT_fmath_errno = 793,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 794,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 795,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 796,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 797,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 798,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 799,                     /* -fmem-report */
  OPT_fmem_report_wpa = 800,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 801,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 802,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 803,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 804,                /* -fmessage-length= */
  OPT_fmodule_private = 805,                 /* -fmodule-private */
  OPT_fmodulo_sched = 806,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 807,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 808,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 809,                  /* -fms-extensions */
  /* OPT_fmudflap = 810, */                  /* -fmudflap */
  /* OPT_fmudflapir = 811, */                /* -fmudflapir */
  /* OPT_fmudflapth = 812, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 813, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 814, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 815,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 816,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 817,                   /* -fnext-runtime */
  OPT_fnil_receivers = 818,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 819,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 820,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 821, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 822,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 823,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 824,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 825,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 826,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 827,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 828,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 829,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 830,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 831,                   /* -foffload-abi= */
  OPT_foffload_ = 832,                       /* -foffload= */
  OPT_fomit_frame_pointer = 833,             /* -fomit-frame-pointer */
  OPT_fopenacc = 834,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 835,                   /* -fopenacc-dim= */
  OPT_fopenmp = 836,                         /* -fopenmp */
  OPT_fopenmp_simd = 837,                    /* -fopenmp-simd */
  OPT_foperator_names = 838,                 /* -foperator-names */
  OPT_fopt_info = 839,                       /* -fopt-info */
  OPT_fopt_info_ = 840,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 841, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 842,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 843,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 844, */           /* -foptional-diags */
  OPT_fpack_derived = 845,                   /* -fpack-derived */
  OPT_fpack_struct = 846,                    /* -fpack-struct */
  OPT_fpack_struct_ = 847,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 848,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 849,              /* -fpcc-struct-return */
  OPT_fpch_deps = 850,                       /* -fpch-deps */
  OPT_fpch_preprocess = 851,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 852,                     /* -fpeel-loops */
  OPT_fpeephole = 853,                       /* -fpeephole */
  OPT_fpeephole2 = 854,                      /* -fpeephole2 */
  OPT_fpermissive = 855,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 856,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 857,                            /* -fpic */
  OPT_fpie = 858,                            /* -fpie */
  OPT_fplan9_extensions = 859,               /* -fplan9-extensions */
  OPT_fplt = 860,                            /* -fplt */
  OPT_fplugin_arg_ = 861,                    /* -fplugin-arg- */
  OPT_fplugin_ = 862,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 863,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 864,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 865,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 866,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 867,                   /* -fpreprocessed */
  OPT_fpretty_templates = 868,               /* -fpretty-templates */
  OPT_fprintf_return_value = 869,            /* -fprintf-return-value */
  OPT_fprofile = 870,                        /* -fprofile */
  OPT_fprofile_abs_path = 871,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 872,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 873,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 874,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 875,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 876,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 877,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 878,                 /* -fprofile-report */
  OPT_fprofile_update_ = 879,                /* -fprofile-update= */
  OPT_fprofile_use = 880,                    /* -fprofile-use */
  OPT_fprofile_use_ = 881,                   /* -fprofile-use= */
  OPT_fprofile_values = 882,                 /* -fprofile-values */
  OPT_fprotect_parens = 883,                 /* -fprotect-parens */
  OPT_frandom_seed = 884,                    /* -frandom-seed */
  OPT_frandom_seed_ = 885,                   /* -frandom-seed= */
  OPT_frange_check = 886,                    /* -frange-check */
  OPT_freal_4_real_10 = 887,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 888,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 889,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 890,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 891,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 892,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 893,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 894,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 895,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 896,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 897,                /* -frecord-marker=8 */
  OPT_frecursive = 898,                      /* -frecursive */
  OPT_free = 899,                            /* -free */
  OPT_freg_struct_return = 900,              /* -freg-struct-return */
  /* OPT_fregmove = 901, */                  /* -fregmove */
  OPT_frename_registers = 902,               /* -frename-registers */
  OPT_freorder_blocks = 903,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 904,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 905,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 906,              /* -freorder-functions */
  OPT_frepack_arrays = 907,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 908,           /* -freplace-objc-classes */
  OPT_frepo = 909,                           /* -frepo */
  OPT_freport_bug = 910,                     /* -freport-bug */
  OPT_frequire_return_statement = 911,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 912,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 913, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 914,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 915,                    /* -fresolution= */
  OPT_frounding_math = 916,                  /* -frounding-math */
  OPT_frtti = 917,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 918,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 919,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 920,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 921,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 922,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 923,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 924,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 925,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 926,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 927,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 928,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 929,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 930,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 931,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 932,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 933,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 934,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 935,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 936,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 937,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 938,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 939,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 940,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 941,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 942, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 943,                /* -fschedule-fusion */
  OPT_fschedule_insns = 944,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 945,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 946,              /* -fsecond-underscore */
  OPT_fsection_anchors = 947,                /* -fsection-anchors */
  /* OPT_fsee = 948, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 949,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 950,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 951, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 952,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 953,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 954,                     /* -fself-test= */
  OPT_fsemantic_interposition = 955,         /* -fsemantic-interposition */
  OPT_fshort_enums = 956,                    /* -fshort-enums */
  OPT_fshort_wchar = 957,                    /* -fshort-wchar */
  OPT_fshow_column = 958,                    /* -fshow-column */
  OPT_fshrink_wrap = 959,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 960,           /* -fshrink-wrap-separate */
  OPT_fsign_zero = 961,                      /* -fsign-zero */
  OPT_fsignaling_nans = 962,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 963,               /* -fsigned-bitfields */
  OPT_fsigned_char = 964,                    /* -fsigned-char */
  OPT_fsigned_zeros = 965,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 966,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 967,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 968,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 969,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 970,                    /* -fsplit-loops */
  OPT_fsplit_paths = 971,                    /* -fsplit-paths */
  OPT_fsplit_stack = 972,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 973,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 974, */                 /* -fsquangle */
  OPT_fssa_backprop = 975,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 976,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 977,                    /* -fsso-struct= */
  OPT_fstack_arrays = 978,                   /* -fstack-arrays */
  /* OPT_fstack_check = 979, */              /* -fstack-check */
  OPT_fstack_check_ = 980,                   /* -fstack-check= */
  OPT_fstack_limit = 981,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 982,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 983,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 984,                /* -fstack-protector */
  OPT_fstack_protector_all = 985,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 986,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 987,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 988,                   /* -fstack-reuse= */
  OPT_fstack_usage = 989,                    /* -fstack-usage */
  OPT_fstats = 990,                          /* -fstats */
  OPT_fstdarg_opt = 991,                     /* -fstdarg-opt */
  OPT_fstore_merging = 992,                  /* -fstore-merging */
  /* OPT_fstrength_reduce = 993, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 994,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 995,                   /* -fstrict-enums */
  /* OPT_fstrict_overflow = 996, */          /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 997, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 998,      /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 999, */        /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1000,            /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 1001,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1002,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1003,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1004, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1005,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1006, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1007,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1008,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1009,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1010, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1011,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1012,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1013,                   /* -ftime-report */
  OPT_ftime_report_details = 1014,           /* -ftime-report-details */
  OPT_ftls_model_ = 1015,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1016,              /* -ftoplevel-reorder */
  OPT_ftracer = 1017,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1018,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1019,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1020,                   /* -ftrampolines */
  OPT_ftrapping_math = 1021,                 /* -ftrapping-math */
  OPT_ftrapv = 1022,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1023,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1024,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1025,                      /* -ftree-ccp */
  OPT_ftree_ch = 1026,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1027, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1028,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1029,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1030, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1031,                   /* -ftree-cselim */
  OPT_ftree_dce = 1032,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1033,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1034,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1035,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1036,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1037, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1038,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1039,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1040, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1041,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1042,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1043, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1044,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1045,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1046,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1047,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1048,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1049,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1050,                      /* -ftree-pre */
  OPT_ftree_pta = 1051,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1052,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1053, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1054,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1055,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1056,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1057,                     /* -ftree-slsr */
  OPT_ftree_sra = 1058,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1059, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1060, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1061,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1062,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1063,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1064, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1065,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1066, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1067,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1068,         /* -funconstrained-commons */
  OPT_funderscoring = 1069,                  /* -funderscoring */
  OPT_funit_at_a_time = 1070,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1071,              /* -funroll-all-loops */
  OPT_funroll_loops = 1072,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1073, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1074,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1075,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1076,                 /* -funsigned-char */
  OPT_funswitch_loops = 1077,                /* -funswitch-loops */
  OPT_funwind_tables = 1078,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1079,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1080,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1081,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1082,                   /* -fuse-ld=gold */
  OPT_fuse_ld_mcld = 1083,                   /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 1084,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1085,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1086,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1087,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1088,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1089,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1090, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1091,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1092,                   /* -fverbose-asm */
  /* OPT_fversion = 1093, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1094,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1095,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1096,                   /* -fvisibility= */
  OPT_fvpt = 1097,                           /* -fvpt */
  /* OPT_fvtable_gc = 1098, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1099, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1100,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1101,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1102,                     /* -fvtv-debug */
  OPT_fweak = 1103,                          /* -fweak */
  OPT_fweb = 1104,                           /* -fweb */
  /* OPT_fwhole_file = 1105, */              /* -fwhole-file */
  OPT_fwhole_program = 1106,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1107,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1108,             /* -fworking-directory */
  OPT_fwpa = 1109,                           /* -fwpa */
  OPT_fwpa_ = 1110,                          /* -fwpa= */
  OPT_fwrapv = 1111,                         /* -fwrapv */
  /* OPT_fxref = 1112, */                    /* -fxref */
  /* OPT_fzee = 1113, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1114,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1115,                     /* -fzero-link */
  OPT_g = 1116,                              /* -g */
  OPT_gant = 1117,                           /* -gant */
  OPT_gcoff = 1118,                          /* -gcoff */
  OPT_gcolumn_info = 1119,                   /* -gcolumn-info */
  OPT_gdwarf = 1120,                         /* -gdwarf */
  OPT_gdwarf_ = 1121,                        /* -gdwarf- */
  OPT_gen_decls = 1122,                      /* -gen-decls */
  OPT_ggdb = 1123,                           /* -ggdb */
  OPT_ggnu_pubnames = 1124,                  /* -ggnu-pubnames */
  OPT_gnat = 1125,                           /* -gnat */
  OPT_gnatO = 1126,                          /* -gnatO */
  OPT_gno_column_info = 1127,                /* -gno-column-info */
  OPT_gno_pubnames = 1128,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1129,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1130,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1131,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1132,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1133,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1134,                   /* -gsplit-dwarf */
  OPT_gstabs = 1135,                         /* -gstabs */
  OPT_gstabs_ = 1136,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1137,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1138,                        /* -gtoggle */
  OPT_gvms = 1139,                           /* -gvms */
  OPT_gxcoff = 1140,                         /* -gxcoff */
  OPT_gxcoff_ = 1141,                        /* -gxcoff+ */
  OPT_gz = 1142,                             /* -gz */
  OPT_gz_ = 1143,                            /* -gz= */
  OPT_h = 1144,                              /* -h */
  OPT_idirafter = 1145,                      /* -idirafter */
  OPT_imacros = 1146,                        /* -imacros */
  OPT_imultiarch = 1147,                     /* -imultiarch */
  OPT_imultilib = 1148,                      /* -imultilib */
  OPT_include = 1149,                        /* -include */
  OPT_iplugindir_ = 1150,                    /* -iplugindir= */
  OPT_iprefix = 1151,                        /* -iprefix */
  OPT_iquote = 1152,                         /* -iquote */
  OPT_isysroot = 1153,                       /* -isysroot */
  OPT_isystem = 1154,                        /* -isystem */
  OPT_iwithprefix = 1155,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1156,              /* -iwithprefixbefore */
  OPT_k8 = 1157,                             /* -k8 */
  OPT_l = 1158,                              /* -l */
  OPT_lang_asm = 1159,                       /* -lang-asm */
  OPT_mabi_ = 1160,                          /* -mabi= */
  OPT_mandroid = 1161,                       /* -mandroid */
  OPT_march_ = 1162,                         /* -march= */
  OPT_mbig_endian = 1163,                    /* -mbig-endian */
  OPT_mbionic = 1164,                        /* -mbionic */
  OPT_mcmodel_ = 1165,                       /* -mcmodel= */
  OPT_mcpu_ = 1166,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1167,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1168,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1169,             /* -mgeneral-regs-only */
  OPT_mglibc = 1170,                         /* -mglibc */
  OPT_mlittle_endian = 1171,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1172,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1173,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1174,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1175,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1176,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1177,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1178,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1179,          /* -msign-return-address= */
  OPT_mstrict_align = 1180,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1181,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1182,                     /* -mtls-size= */
  OPT_mtune_ = 1183,                         /* -mtune= */
  OPT_muclibc = 1184,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1185,             /* -mverbose-cost-dump */
  OPT_n = 1186,                              /* -n */
  OPT_no_canonical_prefixes = 1187,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1188,              /* -no-integrated-cpp */
  OPT_no_pie = 1189,                         /* -no-pie */
  OPT_nocpp = 1190,                          /* -nocpp */
  OPT_nodefaultlibs = 1191,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1192,                   /* -nostartfiles */
  OPT_nostdinc = 1193,                       /* -nostdinc */
  OPT_nostdinc__ = 1194,                     /* -nostdinc++ */
  OPT_nostdlib = 1195,                       /* -nostdlib */
  OPT_o = 1196,                              /* -o */
  OPT_p = 1197,                              /* -p */
  OPT_pass_exit_codes = 1198,                /* -pass-exit-codes */
  /* OPT_pedantic = 1199, */                 /* -pedantic */
  OPT_pedantic_errors = 1200,                /* -pedantic-errors */
  OPT_pg = 1201,                             /* -pg */
  OPT_pie = 1202,                            /* -pie */
  OPT_pipe = 1203,                           /* -pipe */
  OPT_posix = 1204,                          /* -posix */
  OPT_print_file_name_ = 1205,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1206,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1207,          /* -print-multi-directory */
  OPT_print_multi_lib = 1208,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1209,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1210,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1211,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1212,               /* -print-prog-name= */
  OPT_print_search_dirs = 1213,              /* -print-search-dirs */
  OPT_print_sysroot = 1214,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1215,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1216,                        /* -profile */
  OPT_pthread = 1217,                        /* -pthread */
  OPT_quiet = 1218,                          /* -quiet */
  OPT_r = 1219,                              /* -r */
  OPT_rdynamic = 1220,                       /* -rdynamic */
  OPT_remap = 1221,                          /* -remap */
  OPT_s = 1222,                              /* -s */
  OPT_save_temps = 1223,                     /* -save-temps */
  OPT_save_temps_ = 1224,                    /* -save-temps= */
  OPT_shared = 1225,                         /* -shared */
  OPT_shared_libgcc = 1226,                  /* -shared-libgcc */
  /* OPT_specs = 1227, */                    /* -specs */
  OPT_specs_ = 1228,                         /* -specs= */
  OPT_static = 1229,                         /* -static */
  OPT_static_libasan = 1230,                 /* -static-libasan */
  OPT_static_libgcc = 1231,                  /* -static-libgcc */
  OPT_static_libgfortran = 1232,             /* -static-libgfortran */
  OPT_static_libgo = 1233,                   /* -static-libgo */
  OPT_static_liblsan = 1234,                 /* -static-liblsan */
  OPT_static_libmpx = 1235,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1236,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1237,               /* -static-libstdc++ */
  OPT_static_libtsan = 1238,                 /* -static-libtsan */
  OPT_static_libubsan = 1239,                /* -static-libubsan */
  /* OPT_std_c__03 = 1240, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1241, */                /* -std=c++0x */
  OPT_std_c__11 = 1242,                      /* -std=c++11 */
  OPT_std_c__14 = 1243,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1244, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1245, */                /* -std=c++1y */
  OPT_std_c__1z = 1246,                      /* -std=c++1z */
  OPT_std_c__98 = 1247,                      /* -std=c++98 */
  OPT_std_c11 = 1248,                        /* -std=c11 */
  /* OPT_std_c1x = 1249, */                  /* -std=c1x */
  /* OPT_std_c89 = 1250, */                  /* -std=c89 */
  OPT_std_c90 = 1251,                        /* -std=c90 */
  OPT_std_c99 = 1252,                        /* -std=c99 */
  /* OPT_std_c9x = 1253, */                  /* -std=c9x */
  OPT_std_f2003 = 1254,                      /* -std=f2003 */
  OPT_std_f2008 = 1255,                      /* -std=f2008 */
  OPT_std_f2008ts = 1256,                    /* -std=f2008ts */
  OPT_std_f95 = 1257,                        /* -std=f95 */
  OPT_std_gnu = 1258,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1259, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1260, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1261,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1262,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1263, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1264, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1265,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1266,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1267,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1268, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1269, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1270,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1271,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1272, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1273, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1274,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1275, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1276, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1277, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1278,                     /* -std=legacy */
  OPT_symbolic = 1279,                       /* -symbolic */
  OPT_t = 1280,                              /* -t */
  OPT_time = 1281,                           /* -time */
  OPT_time_ = 1282,                          /* -time= */
  OPT_tno_android_cc = 1283,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1284,                 /* -tno-android-ld */
  OPT_traditional = 1285,                    /* -traditional */
  OPT_traditional_cpp = 1286,                /* -traditional-cpp */
  OPT_trigraphs = 1287,                      /* -trigraphs */
  OPT_u = 1288,                              /* -u */
  OPT_undef = 1289,                          /* -undef */
  OPT_v = 1290,                              /* -v */
  OPT_version = 1291,                        /* -version */
  OPT_w = 1292,                              /* -w */
  OPT_wrapper = 1293,                        /* -wrapper */
  OPT_x = 1294,                              /* -x */
  OPT_z = 1295,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
