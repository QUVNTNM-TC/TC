...
enum opt_code
{
  ...
  OPT_mabi_ = 1181,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1182,             /* -mabort-on-noreturn */
  OPT_mandroid = 1183,                       /* -mandroid */
  OPT_mapcs = 1184,                          /* -mapcs */
  OPT_mapcs_frame = 1185,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1186,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1187,              /* -mapcs-stack-check */
  OPT_march_ = 1188,                         /* -march= */
  OPT_marm = 1189,                           /* -marm */
  OPT_masm_syntax_unified = 1190,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1191,                    /* -mbig-endian */
  OPT_mbionic = 1192,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1193,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1194,     /* -mcaller-super-interworking */
  OPT_mcmse = 1195,                          /* -mcmse */
  OPT_mcpu_ = 1196,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1197,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1198,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1199,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1200,                  /* -mfp16-format= */
  OPT_mfpu_ = 1201,                          /* -mfpu= */
  OPT_mglibc = 1202,                         /* -mglibc */
  /* OPT_mhard_float = 1203, */              /* -mhard-float */
  OPT_mlittle_endian = 1204,                 /* -mlittle-endian */
  OPT_mlong_calls = 1205,                    /* -mlong-calls */
  OPT_mmusl = 1206,                          /* -mmusl */
  OPT_mneon_for_64bits = 1207,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1208,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1209,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1210,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1211,               /* -mprint-tune-info */
  OPT_mpure_code = 1212,                     /* -mpure-code */
  OPT_mrestrict_it = 1213,                   /* -mrestrict-it */
  OPT_msched_prolog = 1214,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1215,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1216,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1217, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1218,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1219,                         /* -mthumb */
  OPT_mthumb_interwork = 1220,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1221,                  /* -mtls-dialect= */
  OPT_mtp_ = 1222,                           /* -mtp= */
  OPT_mtpcs_frame = 1223,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1224,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1225,                         /* -mtune= */
  OPT_muclibc = 1226,                        /* -muclibc */
  OPT_munaligned_access = 1227,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1228,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1229,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1230,              /* -mword-relocations */
  OPT_n = 1231,                              /* -n */
  ...
  OPT_pie = 1247,                            /* -pie */
  OPT_pipe = 1248,                           /* -pipe */
  OPT_posix = 1249,                          /* -posix */
  OPT_print_file_name_ = 1250,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1251,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1252,          /* -print-multi-directory */
  OPT_print_multi_lib = 1253,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1254,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1255,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1256,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1257,               /* -print-prog-name= */
  OPT_print_search_dirs = 1258,              /* -print-search-dirs */
  OPT_print_sysroot = 1259,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1260,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1261,                        /* -profile */
  OPT_pthread = 1262,                        /* -pthread */
  OPT_quiet = 1263,                          /* -quiet */
  OPT_r = 1264,                              /* -r */
  OPT_rdynamic = 1265,                       /* -rdynamic */
  OPT_remap = 1266,                          /* -remap */
  OPT_s = 1267,                              /* -s */
  OPT_s_bc_abi = 1268,                       /* -s-bc-abi */
  OPT_save_temps = 1269,                     /* -save-temps */
  OPT_save_temps_ = 1270,                    /* -save-temps= */
  OPT_shared = 1271,                         /* -shared */
  OPT_shared_libgcc = 1272,                  /* -shared-libgcc */
  /* OPT_specs = 1273, */                    /* -specs */
  OPT_specs_ = 1274,                         /* -specs= */
  OPT_static = 1275,                         /* -static */
  OPT_static_libasan = 1276,                 /* -static-libasan */
  OPT_static_libgcc = 1277,                  /* -static-libgcc */
  OPT_static_libgcj = 1278,                  /* -static-libgcj */
  OPT_static_libgfortran = 1279,             /* -static-libgfortran */
  OPT_static_libgo = 1280,                   /* -static-libgo */
  OPT_static_liblsan = 1281,                 /* -static-liblsan */
  OPT_static_libmpx = 1282,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1283,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1284,               /* -static-libstdc++ */
  OPT_static_libtsan = 1285,                 /* -static-libtsan */
  OPT_static_libubsan = 1286,                /* -static-libubsan */
  /* OPT_std_c__03 = 1287, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1288, */                /* -std=c++0x */
  OPT_std_c__11 = 1289,                      /* -std=c++11 */
  OPT_std_c__14 = 1290,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1291, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1292, */                /* -std=c++1y */
  OPT_std_c__1z = 1293,                      /* -std=c++1z */
  OPT_std_c__98 = 1294,                      /* -std=c++98 */
  OPT_std_c11 = 1295,                        /* -std=c11 */
  /* OPT_std_c1x = 1296, */                  /* -std=c1x */
  /* OPT_std_c89 = 1297, */                  /* -std=c89 */
  OPT_std_c90 = 1298,                        /* -std=c90 */
  OPT_std_c99 = 1299,                        /* -std=c99 */
  /* OPT_std_c9x = 1300, */                  /* -std=c9x */
  OPT_std_f2003 = 1301,                      /* -std=f2003 */
  OPT_std_f2008 = 1302,                      /* -std=f2008 */
  OPT_std_f2008ts = 1303,                    /* -std=f2008ts */
  OPT_std_f95 = 1304,                        /* -std=f95 */
  OPT_std_gnu = 1305,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1306, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1307, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1308,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1309,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1310, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1311, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1312,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1313,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1314,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1315, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1316, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1317,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1318,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1319, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1320, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1321,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1322, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1323, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1324, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1325,                     /* -std=legacy */
  OPT_symbolic = 1326,                       /* -symbolic */
  OPT_t = 1327,                              /* -t */
  OPT_time = 1328,                           /* -time */
  OPT_time_ = 1329,                          /* -time= */
  OPT_tno_android_cc = 1330,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1331,                 /* -tno-android-ld */
  OPT_traditional = 1332,                    /* -traditional */
  OPT_traditional_cpp = 1333,                /* -traditional-cpp */
  OPT_trigraphs = 1334,                      /* -trigraphs */
  OPT_u = 1335,                              /* -u */
  OPT_undef = 1336,                          /* -undef */
  OPT_v = 1337,                              /* -v */
  OPT_version = 1338,                        /* -version */
  OPT_w = 1339,                              /* -w */
  OPT_wrapper = 1340,                        /* -wrapper */
  OPT_x = 1341,                              /* -x */
  OPT_z = 1342,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
